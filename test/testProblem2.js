...
var problem2_fn =require('../problem2'); //importing function from problem2.js and storing in problem2_fn
...
/*calling imported function sending given array and last car id i.e 50 as parameter and storing 
what the function returns in a variable of array*/
let detailsOfLastCar=problem2_fn(inventory,50);

//printing the array which contains deatils of car with given id=33
console.log(`Last car is a ${detailsOfLastCar[0].car_make} ${detailsOfLastCar[0].car_model}
`)
