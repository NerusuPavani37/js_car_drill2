...
var problem4_fn=require('../problem4');//importing function from problem4js and storing in problem4_fn
...
what the function returns i.e all the years of cars in inventory, in a variable of array*/
var allTheYearsOfCars = problem4_fn(inventory);

console.log(allTheYearsOfCars);//printing the array of all the years of cars
