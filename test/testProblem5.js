...
var problem5_fn=require('../problem5');//importing function from problem5.js and storing in problem5_fn
...
/*calling imported function and sending given array as parameter and storing 
what the function returns i.e array of older cars , in a variable of array*/
var deatilsOfOldCars = problem5_fn(inventory);

//prints the count of old cars
console.log(deatilsOfOldCars.length);

console.log(deatilsOfOldCars);//printing the array of oldcars manufactured before 2000
