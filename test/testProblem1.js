...
var problem1_fn =require('../problem1'); //importing function from problem1.js and storing in problem1_fn
...
/*calling imported function sending given array and id i.e 33 as parameter and storing 
what the function returns in a variable of array*/
let detailsOfCar = problem1_fn(inventory,33);

//printing the array which contains deatils of car with given id=33
console.log(`Car ${detailsOfCar[0].id} is a ${detailsOfCar[0].car_year} ${detailsOfCar[0].car_make} ${detailsOfCar[0].car_model}`);